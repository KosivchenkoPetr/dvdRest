...
class DiskTest {
    ...
    void testEquals() {
        ...
        assertTrue(disk.equals(diskOther));
        assertFalse(disk.equals(null));
        assertFalse(disk.equals(diskOtherId));
        assertFalse(disk.equals(diskOtherName));
        assertFalse(disk.equals(diskOtherMaster));
        assertFalse(disk.equals(diskOtherOwner));
